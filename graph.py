...
plt.xlabel('Time (mms)', fontsize = 5)
plt.ylabel('Heart Rate (bpm)', fontsize = 5)
plt.title('Analyzing Health conditions, Mood, and Sleeping Patterns from Heart Beats', fontsize = 10)
#plt.show()
